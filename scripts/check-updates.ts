...
const release = {
  tag_name: 'v0.2.0',
  body: '  ## What changed\n- things\n  ',
  html_url: 'https://github.com/smartworldarafath/Surfex---Movies-and-Series/releases/tag/v0.2.0',
  draft: false,
  prerelease: false,
  assets: [
    { name: 'Surfex_0.2.0_amd64.AppImage', browser_download_url: 'https://example.invalid/appimage' },
    { name: 'Surfex_0.2.0.apk', browser_download_url: 'https://example.invalid/apk' },
  ],
}
...
// crosses from TS into Kotlin through the SurfexScreen bridge, which no compiler
