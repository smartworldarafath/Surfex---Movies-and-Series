...
class MainActivity : TauriActivity() {
  ...
  private var player: SurfexPlayer? = null
  ...
  override fun onWebViewCreate(webView: WebView) {
    ...
    // wry's whole create block. The window keeps its own surfex_ground behind
  ...
  inner class Screen {
    ...
    private fun maxFile(dir: java.io.File, free: Long): Long {
      ...
      val probe = java.io.File(dir, ".surfex-size-probe")
      return try {
    ...
    /**
     * Fetch a new build of Surfex and hand it to Android's package installer.
     *
