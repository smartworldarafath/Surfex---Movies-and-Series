  ...
  <header class="flex shrink-0 items-center gap-1 px-3 py-3 sm:gap-2 sm:px-5">
    ...
    <div class="ms-auto flex items-center gap-1 sm:gap-2">
      ...
      <v-badge
        ...
        offset-y="10"
      >
        <v-btn icon variant="text" color="on-surface" :to="localePath('/settings/updates')">
          <v-icon :icon="mdiUpdate" />
          <v-tooltip activator="parent" :text="$t('Surfex {version} is out', { version: updates.available.version })" />
        </v-btn>
      </v-badge>
