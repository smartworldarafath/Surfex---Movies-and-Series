...
const TABLE = {
  ...
  dark: {
    ...
    backdrop: { mode: 'custom', image: '/backgrounds/surfex-dark.svg' },
  },
  ...
  // Surfex Dark upside down. The red drops to tone 45 because `#ff5555` on white
  ...
  light: {
    ...
    backdrop: { mode: 'custom', image: '/backgrounds/surfex-light.svg' },
  },
